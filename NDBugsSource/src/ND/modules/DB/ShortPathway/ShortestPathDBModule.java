 ...
 * @author scsandra
 */
public class ShortestPathDBModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Find shortest paths";
        private final ShortestPathDBParameters parameters = new ShortestPathDBParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new ShortestPathDBTask[1];
              
                tasks[0] = new ShortestPathDBTask((SimpleParameterSet) parameters);
