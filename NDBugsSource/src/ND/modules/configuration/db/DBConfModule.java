 ...
 * @author scsandra
 */
public class DBConfModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Graph DB configuration";
        private final DBConfParameters parameters = new DBConfParameters();
