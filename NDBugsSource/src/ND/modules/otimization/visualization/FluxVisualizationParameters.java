...
public class FluxVisualizationParameters extends SimpleParameterSet {

        public static final StringParameter objective = new StringParameter(
                "Compound", "ID of the compound you want to visualize");  

        public FluxVisualizationParameters() {
