...
import ND.modules.analysis.FBAVisualization.*;
import ND.modules.analysis.ClycleDetector.*;
 ...
 * @author scsandra
 */
public class VisualizeCofactorsModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Visualize Cofactor transport";
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new VisualizeCofactorsTask[1];
                SimpleBasicDataset dataset = null;
                try {
                        dataset = (SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0];
                } catch (Exception e) {
                }
                tasks[0] = new VisualizeCofactorsTask(dataset, (SimpleParameterSet) parameters);
