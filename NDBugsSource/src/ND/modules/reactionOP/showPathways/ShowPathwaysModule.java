 ...
 * @author scsandra
 */
public class ShowPathwaysModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Show Pathways";
        private final ShowPathwaysParameters parameters = new ShowPathwaysParameters();
