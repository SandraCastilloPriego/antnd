 ...
 * @author scsandra
 */
public class FluxCalcModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Calculate Compound Flux";
        private final FluxCalcParameters parameters = new FluxCalcParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new FluxCalcTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {

                        tasks[0] = new FluxCalcTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
