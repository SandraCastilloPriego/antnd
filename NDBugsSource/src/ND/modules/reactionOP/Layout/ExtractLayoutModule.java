 ...
 * @author scsandra
 */
public class ExtractLayoutModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Extract Nodes From Layout";
        private final ExtractLayoutParameters parameters = new ExtractLayoutParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new ExtractLayoutTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {

                        tasks[0] = new ExtractLayoutTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
