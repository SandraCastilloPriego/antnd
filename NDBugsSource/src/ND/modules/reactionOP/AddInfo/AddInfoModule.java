 ...
 * @author scsandra
 */
public class AddInfoModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Adding information";
        private final AddInfoParameters parameters = new AddInfoParameters();
