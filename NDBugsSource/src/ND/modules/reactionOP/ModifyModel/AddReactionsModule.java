 ...
 * @author scsandra
 */
public class AddReactionsModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Add Reactions";
        private AddReactionsParameters parameters = new AddReactionsParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new AddReactionsTask[1];
                SimpleBasicDataset dataset = null;
                try {
                        dataset = (SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0];
                } catch (Exception e) {
                }
                tasks[0] = new AddReactionsTask(dataset, (SimpleParameterSet) parameters);
