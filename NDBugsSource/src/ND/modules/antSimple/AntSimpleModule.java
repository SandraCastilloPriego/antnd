 ...
 * @author scsandra
 */
public class AntSimpleModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Ant flux";
        private AntSimpleModuleParameters parameters = new AntSimpleModuleParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new AntSimpleModuleTask[1];

                tasks[0] = new AntSimpleModuleTask((SimpleBasicDataset)NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
