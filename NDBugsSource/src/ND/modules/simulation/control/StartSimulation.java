 ...
 * @author scsandra
 */
public class StartSimulation implements NDProcessingModule {

        public static final String MODULE_NAME = "Start Simulation";
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                tasks[0] = new StartSimulationTask(dataset, (SimpleParameterSet) parameters);
