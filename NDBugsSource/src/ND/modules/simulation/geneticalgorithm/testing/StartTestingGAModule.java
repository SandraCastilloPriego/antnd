 ...
 * @author scsandra
 */
public class StartTestingGAModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Testing Genetic Algorith";
        private StartTestingGAParameters parameters = new StartTestingGAParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new StartTestingGATask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {
                        tasks[0] = new StartTestingGATask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
