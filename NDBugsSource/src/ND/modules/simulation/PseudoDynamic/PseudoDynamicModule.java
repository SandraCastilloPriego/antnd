 ...
 * @author scsandra
 */
public class PseudoDynamicModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Start PD flux";
        private final PseudoDynamicParameters parameters = new PseudoDynamicParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new PseudoDynamicTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {
                        tasks[0] = new PseudoDynamicTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
