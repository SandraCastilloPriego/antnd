...
public class LPTask extends AbstractTask {
    ...
    public LPTask(SimpleBasicDataset dataset, SimpleParameterSet parameters) {
        ...
        String c = parameters.getParameter(LPParameters.cofactors).getValue();
        this.cofactors.addAll(Arrays.asList(c.split(",")));
    }
    ...
    public double getFlux(String objective) {
        ...
        fba.setModel("objective", this.reactions, this.cofactors,this.networkDS.getDocument().getModel());
        try {
