 ...
 * @author scsandra
 */
public class AntFluxMinModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Start Minimizing Flux Ant";
        private final AntFluxMinParameters parameters = new AntFluxMinParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new AntFluxMinTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {
                        tasks[0] = new AntFluxMinTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
