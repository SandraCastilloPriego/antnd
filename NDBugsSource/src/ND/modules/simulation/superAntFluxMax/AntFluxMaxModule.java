 ...
 * @author scsandra
 */
public class AntFluxMaxModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Start Maximizing Flux Ant";
        private final AntFluxMaxParameters parameters = new AntFluxMaxParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new AntFluxMaxTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {
                        tasks[0] = new AntFluxMaxTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
