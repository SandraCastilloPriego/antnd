...
{
	private List< ReactionFA > reactions = null;
	Vector< SpeciesFA > metabolites = null;
	...
	public List< ReactionFA > getReactions()
	{
		return reactions;
	}

	@SuppressWarnings( "unchecked" )
	public void setReactions( List< ReactionFA > reactions )
	{
		this.reactions = reactions;
		this.lowerBounds = new ArrayList< Double >();
		this.upperBounds = new ArrayList< Double >();
		
		for( ReactionFA r : reactions )
		{
			lowerBounds.add( r.getlb() );
			upperBounds.add( r.getub() );
		}
	...
	//	compareCSV( "MostUB-red-part.txt", "MatlabUB-red-part.txt", "\t" );
		...
		for( int i = 0; i < reactions.size(); ++i )
		{
			reactions.get( i ).setBounds(lowerBounds.get( i ),upperBounds.get( i ) );			
		}
	...
	*/
	...
	@SuppressWarnings( "unchecked" )
	public void setMetabolites( Vector< SpeciesFA > metabolites )
	{
		this.metabolites = (Vector< SpeciesFA >)metabolites.clone();
	}
	
	public Vector< SpeciesFA > getMetabolites()
	{
		return metabolites;
	}
