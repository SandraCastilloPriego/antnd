 ...
 * @author scsandra
 */
public class AntFBADistributionModule implements NDProcessingModule {

        public static final String MODULE_NAME = "FBA - Flux distribution";
        private AntFBADistributionParameters parameters = new AntFBADistributionParameters();
        @Override
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new AntFBADistributionTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {
                        tasks[0] = new AntFBADistributionTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
