 ...
 * @author scsandra
 */
public class DynamicModule implements NDProcessingModule {

    public static final String MODULE_NAME = "COPASI";
    private final DynamicParameters parameters = new DynamicParameters();
    ...
    public Task[] runModule(ParameterSet parameters) {
        ...
        Task tasks[] = new DynamicTask[1];

        tasks[0] = new DynamicTask((SimpleParameterSet) parameters);
