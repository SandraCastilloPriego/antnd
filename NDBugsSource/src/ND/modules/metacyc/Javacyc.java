...
public class Javacyc {
     ...
     * @return the results from the server in an ArrayList. Some of the elements
     * in the returned ArrayList may be ArrayLists themselves.
     */
    ...
    /**
     * Changes the organism. Does not make a call to the select-organism lisp
     * function in Pathway-Tools. Does not make any calls to Pathway-Tools
     * functions. The organism is prefixed to every query sent to the socket
     * server.
     *
     ...
     * @return an ArrayList of all genes that code for enzymes that catalyze the
     * reaction rxn
     */
     ...
     * @return an ArrayList containing the reactants of rxn and the products of
     * rxn. Some of the elements of the returned ArrayList may be ArrayLists
     * themselves.
     */
     ...
     * @param rxn a reaction frame
     * @param pwy a pathway frame
     * @return an ArrayList of all reactions that are direct predecessors of rxn
     * in pwy
     */
     ...
     * @param rxn a reaction frame
     * @param pwy a pathway frame
     * @return an ArrayList of all reactions that are direct successors of rxn
     * in pwy
     */
     ...
     *
     * @param pwy a pathway frame
     * @return an ArrayList of ArrayLists that contain the values returned by
     * Pathway Tools
     */
     ...
     * @return true if protein is a trascription factor in the current organism
     */
     ...
     *
     * @param protein a protein
     * @return an ArrayList of components and their coefficients. Some of the
     ...
     *
     * @param protein a protein
     * @return an ArrayList of transcription units regulated by any modified or
     ...
     *
     * @param protein a protein
     * @return an ArrayList of transcripton units activated or inhibited by the
     ...
     *
     * @param tu a transcription unit
     * @return an ArrayList of DNA binding sites within the transcriptional unit
     */
     ...
     * @return an ArrayList of the reactions in which cpd occurs as a reactant
     * or a product
     */
     ...
     * @return an ArrayList representation of the lisp list returned by Pathway
     * Tools
     */
    ...
    private void sendQuery(String query) {
        ...
        try {
          ...
          /*  String line;
            ...
            File fXmlFile = new File("C:\\Users\\scsandra\\Documents\\Metacyc\\xmlquery.xml");
